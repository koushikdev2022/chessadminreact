...
const AddModuleModal = ({ openAddModuleModal, setOpenAddModuleModal }) => {
    ...
    return (
        <>
            <Modal show={openAddModuleModal} onClose={() => setOpenAddModuleModal(false)}>
                        ...
                        <div className="space-y-4 max-w-full md:max-w-lg mx-auto px-2 sm:px-4">
                            <div>
                                ...
                                >
                                    ...
                                    {allTopics?.data
                                        ?.filter((topic) => topic?.status === 1 && topic?.is_deleted === 0)
                                        .map((topic) => (
                                ...
                                {errors?.topic_id && <p className="text-red-500 text-sm">{errors.topic_id.message}</p>}
                            </div>
                            <div>
                                <Label htmlFor="module_name" value="Module Name" />
                                <TextInput
                                    id="module_name"
                                    {...register("module_name", { required: "Topic Name is required" })}
                                />
