...
const UpdateTopicModal = ({ openUpdateTopicModal, setOpenUpdateTopicModal, topicId }) => {
    ...
    return (
        <>
            <Modal show={openUpdateTopicModal} onClose={() => setOpenUpdateTopicModal(false)}>
                <Modal.Header>Update This Topic</Modal.Header>
                        ...
                        <div className="space-y-4 max-w-full md:max-w-lg mx-auto px-2 sm:px-4">
                            ...
                            <div>
                                ...
                                {errors?.topic_short_name && (
                                    <p className="text-red-500 text-sm">{errors.topic_short_name.message}</p>
                                )}
                            </div>
                            <div>
                                ...
                                <Textarea
                                    ...
                                    rows={3}
                                    {...register("topic_description", { required: "Description is required" })}
                                />
                                {errors?.topic_description && (
                                    <p className="text-red-500 text-sm">{errors.topic_description.message}</p>
                                )}
                            </div>
                        </div>
                    </Modal.Body>
